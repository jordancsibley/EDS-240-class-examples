...
Notice that in the histogram you can compare between group A and B in terms of number of counts (A has less than B). The density plot shows them as the same size which can be deceiving. 
